...
class Chat{
	...
	public static function submitChat($chatText){
		...
		if(!$chatText){
			throw new Exception('You have not entered a chat message.');
		}
	...
	public statis function getUsers(){
		if($_SESSION['user']['name']){
		...
		$result = DB::query('SELECT * FROM webchat_users ORBER BY name ASC LIMIT 18');
